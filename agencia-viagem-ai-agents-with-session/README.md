...
mvn io.quarkus.platform:quarkus-maven-plugin:3.2.10.Final:create \
  -DprojectGroupId=dev.ai \
  -DprojectArtifactId=agencia-viagem-ai-agents-with-session \
  -Dextensions="quarkus-rest,quarkus-langchain4j-ollama,quarku
s-langchain4j-pgvector,quarkus-jdbc-postgresql"
...
You can then execute your native executable with: `./target/agencia-viagem-ai-agents-with-session-1.0.0-SNAPSHOT-runner`
