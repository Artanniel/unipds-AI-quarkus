...
mvn io.quarkus.platform:quarkus-maven-plugin:3.30.2:create \
  ...
  -DprojectArtifactId=mcp-booking-server-with-guardrails \
  -DprojectVersion=1.0-SNAPSHOT \
  -DjavaVersion=21 \
  -Dextensions="quarkus-rest,quarkus-arc,quarkus-mcp-server-sse"
...
You can then execute your native executable with: `./target/mcp-booking-server-with-guardrails-1.0-SNAPSHOT-runner`
